...
final class MatcherMatchResult implements MatchResult {
    ...
    /* JADX DEBUG: Method not inlined, still used in: [kotlin.text.MatcherMatchResult$groupValues$1.get(int):java.lang.String, kotlin.text.MatcherMatchResult$groupValues$1.getSize():int] */
        ...
        if (this.groupValues_ == null) {
            this.groupValues_ = new AbstractList<String>() { // from class: kotlin.text.MatcherMatchResult$groupValues$1
                ...
                public String get(int i) {
                    String group = MatcherMatchResult.access$getMatchResult$p(MatcherMatchResult.this).group(i);
