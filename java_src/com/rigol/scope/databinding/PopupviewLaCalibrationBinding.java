...
public abstract class PopupviewLaCalibrationBinding extends ViewDataBinding {
    ...
    protected PopupviewLaCalibrationBinding(Object obj, View view, int i, Button button, TextView textView, ImageView imageView, TextView textView2, ScrollView scrollView, View view2, Guideline guideline, Guideline guideline2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, ConstraintLayout constraintLayout, NumberProgressBar numberProgressBar, TextView textView7, TextView textView8, Button button2, TextView textView9) {
        super(obj, view, i);
        this.close = button;
