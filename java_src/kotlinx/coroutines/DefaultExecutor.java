...
public final class DefaultExecutor extends EventLoopImplBase implements Runnable {
    ...
    /* JADX DEBUG: Another duplicated slice has different insns count: {[CHECK_CAST, SPUT, INVOKE, INVOKE]}, finally: {[CHECK_CAST, SPUT, INVOKE, INVOKE, INVOKE, IF, INVOKE, INVOKE, INVOKE, IF, INVOKE, IF] complete} */
    /* JADX DEBUG: Don't trust debug lines info. Repeating lines: [87=4, 88=4, 89=4, 91=4] */
