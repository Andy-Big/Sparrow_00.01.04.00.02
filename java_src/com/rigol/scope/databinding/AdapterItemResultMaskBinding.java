...
public abstract class AdapterItemResultMaskBinding extends ViewDataBinding {
    ...
    protected AdapterItemResultMaskBinding(Object obj, View view, int i, ImageView imageView, DisableTouchEventRecyclerView disableTouchEventRecyclerView, TextView textView, ConstraintLayout constraintLayout) {
        super(obj, view, i);
        this.icon = imageView;
