...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    /* JADX DEBUG: Method not inlined, still used in: [kotlinx.coroutines.channels.ConflatedBroadcastChannel$onSend$1.registerSelectClause2(kotlinx.coroutines.selects.SelectInstance<? super R>, E, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.channels.SendChannel<? super E>, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object>):void] */
    ...
    public SelectClause2<E, SendChannel<E>> getOnSend() {
        return (SelectClause2) ((SelectClause2<E, SendChannel<? super E>>) new SelectClause2<E, SendChannel<? super E>>() { // from class: kotlinx.coroutines.channels.ConflatedBroadcastChannel$onSend$1
            ...
            public <R> void registerSelectClause2(SelectInstance<? super R> select, E e, Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> block) {
                ...
                ConflatedBroadcastChannel.access$registerSelectSend(ConflatedBroadcastChannel.this, select, e, block);
            }
        });
    }
