...
public abstract class SegmentQueue<S extends Segment<S>> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: kotlinx.coroutines.internal.SegmentQueue<S extends kotlinx.coroutines.internal.Segment<S>> */
    /* JADX DEBUG: Multi-variable search result rejected for r7v9, resolved type: S extends kotlinx.coroutines.internal.Segment<S> */
    /* JADX WARN: Multi-variable type inference failed */
    protected final S getSegment(S startFrom, long j) {
    ...
    protected final S getSegmentAndMoveHead(S startFrom, long j) {
        Intrinsics.checkParameterIsNotNull(startFrom, "startFrom");
        if (startFrom.getId() == j) {
            return startFrom;
        }
