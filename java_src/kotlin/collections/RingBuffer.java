...
final class RingBuffer<T> extends AbstractList<T> implements RandomAccess {
    ...
    /* JADX DEBUG: Method not inlined, still used in: [kotlin.collections.RingBuffer$iterator$1.computeNext():void] */
    ...
    /* JADX DEBUG: Method not inlined, still used in: [kotlin.collections.RingBuffer$iterator$1.<init>(kotlin.collections.RingBuffer):void] */
