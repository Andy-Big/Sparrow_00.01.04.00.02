.class public Lcom/rigol/scope/views/grid/GridRulerView;
...
# static fields
.field public static final Companion:Lcom/rigol/scope/views/grid/GridRulerView$Companion;

.field private static final DEFAULT_DASH_PATH_EFFECT:Landroid/graphics/PathEffect;

.field public static final DEFAULT_PADDING:F = 10.0f

.field public static final DEFAULT_TEXT_SIZE:F = 16.0f
...
.field private final columnTextPaint:Landroid/graphics/Paint;
...
.field private final rowTextPaint:Landroid/graphics/Paint;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/rigol/scope/views/grid/GridRulerView$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/rigol/scope/views/grid/GridRulerView$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    sput-object v0, Lcom/rigol/scope/views/grid/GridRulerView;->DEFAULT_DASH_PATH_EFFECT:Landroid/graphics/PathEffect;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/rigol/scope/views/grid/GridRulerView$1;

    invoke-direct {v1, p0}, Lcom/rigol/scope/views/grid/GridRulerView$1;-><init>(Lcom/rigol/scope/views/grid/GridRulerView;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    new-instance v0, Lcom/rigol/scope/views/grid/GridRulerView$1;

    invoke-direct {v0, p0}, Lcom/rigol/scope/views/grid/GridRulerView$1;-><init>(Lcom/rigol/scope/views/grid/GridRulerView;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance p3, Lcom/rigol/scope/views/grid/GridRulerView$1;

    invoke-direct {p3, p0}, Lcom/rigol/scope/views/grid/GridRulerView$1;-><init>(Lcom/rigol/scope/views/grid/GridRulerView;)V
...
.method private final drawColumnMiddleScale(FILandroid/graphics/Canvas;)V
    ...
    iget-object v9, v0, Lcom/rigol/scope/views/grid/GridRulerView;->solidLinePaint:Landroid/graphics/Paint;
...
.method private final drawColumnSideScaleLine(FILandroid/graphics/Canvas;)V
    ...
    iget-object v8, p0, Lcom/rigol/scope/views/grid/GridRulerView;->scaleLinePaint:Landroid/graphics/Paint;
...
.method private final drawColumns(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v2, p0, Lcom/rigol/scope/views/grid/GridRulerView;->isMain:Z
